...
namespace BS.Unpacker
{
    class Program
    {
        private static String m_Title = "Bright Shadow PAK Unpacker";
        ...
        static void Main(String[] args)
        {
            ...
            if (args.Length != 2)
            {
                ...
                Console.WriteLine("    BS.Unpacker <m_File> <m_Directory>\n");
                Console.WriteLine("    m_File - Source of PAK archive file");
                Console.WriteLine("    m_Directory - Destination directory\n");
                Console.ResetColor();
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine("[Examples]");
                Console.WriteLine("    BS.Unpacker E:\\Games\\BS\\DATA.PAK D:\\Unpacked");
                Console.ResetColor();
                return;
            }
